  ...
  return (
    <div class="app">
      <header class="hero">
        ...
        <h1>Playground (SSR)</h1>
        <p class="lede">
          Same MobX MVVM store, rendered with <code>renderToString</code> and
          hydrated via <code>enableObservableTracking</code>.
        </p>
      </header>
      ...
      <aside class="api-notes">
        ...
        <ul>
          <li>
            <code>enableObservableTracking()</code> — in{" "}
            <code>entry-server.tsx</code> and <code>entry-client.tsx</code>
          </li>
          <li>
            Server: <code>renderToString</code> + <code>generateHydrationScript</code>
          </li>
          <li>
            Client: <code>hydrate</code> — MobX stays reactive after hydration
          </li>
          <li>
